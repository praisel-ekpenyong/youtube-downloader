...
- [ ] Wizard prompts for `live_from_start` option.
- [ ] Wizard prompts independently for subtitles, chapters, metadata tags, and thumbnail artwork.
- [ ] Unit tests in `tests/test_wizard.py` verify all interactive prompt paths and flag assignments.
