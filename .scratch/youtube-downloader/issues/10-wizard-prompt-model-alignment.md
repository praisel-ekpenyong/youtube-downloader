...
- [x] Interactive wizard prompts query `media_profile.supports_subtitles` for subtitle configuration.
- [x] Interactive wizard tests in `tests/test_wizard.py` verify prompt skips and option assignments for audio and video profiles.
